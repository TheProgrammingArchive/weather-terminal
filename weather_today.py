...
class weatherHourly:
    def weather_atThisHour(self):
        ...
        return [time_now, temperature_current, weatherdesc_current, precipindex_current, windsdp_current]
    ...
    def getHourlyweather(self):
        for reports in soup.find_all('details', class_='DaypartDetails--DayPartDetail--3yhtR Disclosure--themeList--uBa5q'):
            ...
            lists = [timeofreport, temperature_Now, weather_description, precip_index, wind_speed]
...
wnow = weatherHourly()
# wnow.getHourlyweather()
print(wnow.getdateofreport())

print(wnow.weather_atThisHour())

for lists in wnow.getHourlyweather():
    print(lists)